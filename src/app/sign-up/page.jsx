...
const SignUpPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Here you would handle account creation logic (API call, etc.)
    setSubmitted(true);
  };
            ...
            <div className="rounded-md shadow-sm -space-y-px">
              ...
              <div>
                ...
                <input
                  ...
                  value={form.email}
                  onChange={handleChange}
                  className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#FAE62F] focus:border-[#FAE62F] focus:z-10 sm:text-sm"
